...
function rgba(firstValue, secondValue, thirdValue, fourthValue) {
    if (typeof firstValue === 'string' && typeof secondValue === 'number') {
        var rgbValue = (0, parseToRgb_1.default)(firstValue);
        ...
        return fourthValue >= 1
            ? (0, rgb_1.default)(firstValue, secondValue, thirdValue)
        ...
        return firstValue.alpha >= 1
            ? (0, rgb_1.default)(firstValue.red, firstValue.green, firstValue.blue)
            : "rgba(" + firstValue.red + "," + firstValue.green + "," + firstValue.blue + "," + firstValue.alpha + ")";
    }
    throw new _errors_1.default(7);
}
